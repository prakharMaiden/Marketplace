                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <?php if(!empty($supplierData["logo"])) {?>
                            <img class="profile-user-img img-fluid img-circle" src="<?php echo PUBLIC_PATH;?>/img/seller/logo/<?php echo $supplierData["logo"]; ?>" alt="User profile picture">
                       <?php }else{ ?>
                                <i class="fas fa-user" aria-hidden="true" style="margin-top: 4px;font-size: 125px;"></i>
                            <?php   }?>
                        </div>

                        <h3 class="profile-username text-center"><?php echo $supplierData["contact_fname"].' '.$supplierData["contact_lname"]; ?></h3>

                        <p class="text-muted text-center"><?php echo $supplierData["company_name"]; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header d-flex p-0">
                        <h3 class="card-title p-3">User Profile</h3>
