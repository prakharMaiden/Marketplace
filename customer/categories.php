    ...
    <div class="ps-page--shop">
        <div class="ps-container">
            <div class="ps-shop-banner">
                <div class="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on"><a href="#"><img src="<?php echo PUBLIC_PATH;?>/img/slider/shop-default/1.jpg" alt=""></a><a href="#"><img src="<?php echo PUBLIC_PATH;?>/img/slider/shop-default/2.jpg" alt=""></a></div>
            </div>
                        ...
                        <ul class="ps-list--categories">
                            ...
                            foreach ($categories as $category) {  ?>
                                <li class="current-menu-item <?php  if($category['child'] != 0){ ?> menu-item-has-children   <?php }?>">
                                    <a href="<?php echo PATH;?>/customer/category.php?id=<?php echo $category['id']  ; ?>">
                                    ...
                                    <?php  if($category['child'] != 0){ ?>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            $subcategories=mysqli_query($con,"select * from subcategory where category_id='$category[id]'") ;
                                            foreach ($subcategories as $subcategory) {  ?>
                                                <li  class="current-menu-item "><a href="<?php echo PATH;?>/customer/subcategory.php?id=<?php echo $subcategory['id']  ; ?>"><?php echo ucfirst($subcategory['name'])  ; ?></a></li>
                                            <?php }?>
                ...
                <div class="ps-layout__right">
                    <div class="ps-block--shop-features">
                        ...
                        <div class="ps-block__content">
                            <div class="owl-slider" id="bestsale" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="2" data-owl-item-lg="3" data-owl-item-xl="4" data-owl-duration="1000" data-owl-mousedrag="on">
                                <?php
                                $products=mysqli_query($con,"select * from products where product_available='yes' and discount != ''") ;
                    ...
                    <div class="ps-shopping ps-tab-root">
                        <div class="ps-shopping__header">
                            <?php
                            $subCountProducts = mysqli_query($con, "select count(*) as Count from  products where  product_available='yes'");
                        ...
                        <div class="ps-tabs">
                            <div class="ps-tab active" id="tab-1">
                                <div class="ps-shopping-product">
                                    <div class="row">
                                        <?php
                                        $subcatproducts = mysqli_query($con, "select * from products where  product_available='yes'");
