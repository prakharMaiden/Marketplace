...
<!-- Mirrored from nouthemes.net/html/martfury/product-multi-vendor.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 May 2020 13:57:03 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
                        ...
                        <li class="menu-item-has-children has-mega-menu"><a href="shop-default.html">Shop</a><span class="sub-toggle"></span>
                            <div class="mega-menu">
                                ...
                                <div class="mega-menu__column">
                                    ...
                                    <ul class="mega-menu__list">
                                        <li class="current-menu-item "><a href="shopping-cart.php">Shopping Cart</a>
                                        </li>
                                        <li class="current-menu-item "><a href="checkout.php">Checkout</a>
                                        </li>
                                        <li class="current-menu-item "><a href="whishlist.php">Whishlist</a>
                                        </li>
                                        <li class="current-menu-item "><a href="compare.php">Compare</a>
                                        </li>
                        ...
                        <li class="menu-item-has-children has-mega-menu"><a href="#">Pages</a><span class="sub-toggle"></span>
                            <div class="mega-menu">
                                <div class="mega-menu__column">
                                    ...
                                    <ul class="mega-menu__list">
                                        <li class="current-menu-item "><a href="about-us.php">About Us</a>
                                        </li>
                                        <li class="current-menu-item "><a href="contact-us.php">Contact</a>
                                        </li>
                                        <li class="current-menu-item "><a href="faqs.php">Faqs</a>
                                        </li>
                                ...
                                <div class="mega-menu__column">
                                    ...
                                    <ul class="mega-menu__list">
                                        ...
                                        <li class="current-menu-item "><a href="vendor-store.php">Vendor Store</a>
                                        </li>
    ...
    <nav class="navigation--mobile-product"><a class="ps-btn ps-btn--black" href="shopping-cart.php">Add to cart</a><a class="ps-btn" href="checkout.php">Buy Now</a></nav>
                        ...
                        <div class="ps-product__header">
                            <div class="ps-product__thumbnail" data-vertical="true">
                                ...
                                <div class="ps-product__variants" data-item="4" data-md="4" data-sm="4" data-arrow="false">
                                    ...
                                    <div class="item">
                                        <div class="ps-video"><a href="https://www.youtube.com/watch?v=ilw-qmqZ5zY"><img src="img/products/detail/fullwidth/3.jpg" alt=""></a></div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="ps-footer__widgets">
                <aside class="widget widget_footer widget_contact-us">
                    ...
                    <div class="widget_content">
                        <p>Call us 24/7</p>
                        <h3>1800 97 97 69</h3>
                        <p>502 New Design Str, Melbourne, Australia <br><a href="http://nouthemes.net/cdn-cgi/l/email-protection#492a26273d282a3d0924283b3d2f3c3b30672a26"><span class="__cf_email__" data-cfemail="c0a3afaeb4a1a3b480ada1b2b4a6b5b2b9eea3af">[email&#160;protected]</span></a></p>
...
<!-- Mirrored from nouthemes.net/html/martfury/product-multi-vendor.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 May 2020 13:57:18 GMT -->
</html>